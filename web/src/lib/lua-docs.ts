...
listenEvents(30)`,
  },
  {
    ...
    entries: [
      ...
      { name: 'hit', signature: 'hit(x: number, y: number)', description: 'Punches the tile dx, dy tiles from the bot. Offsets, not absolute coordinates, and beyond four tiles it is ignored.' },
      { name: 'wrench', signature: 'wrench(x: number, y: number)', description: 'Wrenches the tile dx, dy tiles from the bot. Offsets, not absolute coordinates, and beyond four tiles it is ignored.' },
    ...
    tables: [
      {
        ...
        rows: [
          ...
          ['collect_range', 'number', 'r/w', 'Auto-collect radius in tiles, 1-5 (default: 3). A client only collects what it touches; larger values pull drops from across the room without moving'],
          ...
          ['jitter_pct', 'number', 'r/w', 'Randomises place_delay and walk_delay by plus or minus this percent on every action. Default 25, clamped to 90, 0 disables'],
        ],
      },
    ],
  },
